...
import formSchema from './validation/formSchema';
  ...
  // consts are here to establish states initial values
  //initial state (which are all empty at first)
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Interested? Join the Cause</h1>
      </header>
       ...
       <Form 
        ...
        errors={formErrors}
       />
      {/* this is creating the individual user in the user component, map through the users array, create inside the user component, an individual user object*/}
      {
        users.map(user => {
          return (
